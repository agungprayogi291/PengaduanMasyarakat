...
require '../../db.php';
  ...
  if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO tanggapan(id_pengaduan,tgl_tanggapan,tanggapan,id_petugas) VALUES('$idPengaduan',now(),'$tanggapan','$idPetugas')";
     $sqlStatus = "UPDATE pengaduan SET status='selesai' WHERE id_pengaduan = '$idPengaduan' ";
    //eksekusi 
    $execute = mysqli_query($conn, $sql);
    $executeUpdateStatus = mysqli_query($conn,$sqlStatus);
      //jika eksekusi berhasil
      if($execute && $executeUpdateStatus){
        echo "<script>
